...
const Bonus = () => (
  <BonusContainer>
    ...
    <BonusBody>
      <TextItem>
        <Sender>Nikita Asabin: </Sender>
        <BonusPoints>
          +50
        </BonusPoints>
        {' '}
        <ReceiverName>@marat.galeev</ReceiverName>
        {' '}
        iOS quiz
        {' '}
        <Tag>#win-win-win</Tag>
