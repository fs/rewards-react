...
describe('BonusContent index', () => {
  ...
  test('should call updateBonusList', async () => {
    //Arrange
    ...
    const mockBonusService = class {
      static fetchBonusesList = jest.fn(
        () => new Promise((resolve) => {
    ...
    //Assert
    await wait(() => {
      expect(mockAuthService.getToken).toBeCalled();
      expect(mockBonusService.fetchBonusesList).toBeCalledWith(expectedToken);
