export default {
  data: [
    ...
    },
    {
      ...
      attributes: {
        text:
          '+1 @olga.krasnova @albert.fazullin @leyla.khamidullina #be-curious-never-stop-learning test react rewards #create-awesomeness',
        points: 1,
        'total-points': 1,
...
export const createBonusResponse = {
  data: {
    id: '4492',
    type: 'bonuses',
    attributes: {
